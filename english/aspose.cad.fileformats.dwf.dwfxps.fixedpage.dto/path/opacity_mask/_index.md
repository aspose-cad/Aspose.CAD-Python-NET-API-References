...
type: docs
weight: 120
url: /python-net/aspose.cad.fileformats.dwf.dwfxps.fixedpage.dto/path/opacity_mask/
is_root: false
---
...
Specifies a mask of alpha values that is applied to the path
in the same fashion as the Opacity attribute,
