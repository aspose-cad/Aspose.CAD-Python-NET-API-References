...
type: docs
weight: 100
url: /python-net/aspose.cad.fileformats.glb.scenes/skinnedtransformer/name/
is_root: false
---
...
So don't use [`ContentTransformer.name`](/cad/python-net/aspose.cad.fileformats.glb.scenes/contenttransformer#name) for anything other than object name display.
